      ...
      <main className="flex-grow flex items-center justify-center pt-32 pb-20 px-6">
        <div className="max-w-3xl mx-auto text-center w-full">
          ...
          >
            ...
            <Link to="/" className="inline-flex items-center justify-center px-8 py-4 text-base font-bold text-white bg-primary rounded-xl hover:bg-primary transition-colors shadow-lg shadow-primary/20">
              Return to Homepage
            </Link>
          </motion.div>
        </div>
