...
export const DashboardLayout: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100">
      {/* 1. Desktop Sidebar */}
      <aside className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 bg-slate-900 text-slate-400 border-r border-slate-800 z-10">
        {/* Brand logo */}
          ...
          {filteredMenuItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {!active && (
                  <ChevronRight className="h-3.5 w-3.5 opacity-0 group-hover:opacity-100 transform translate-x-1 transition-all" />
                )}
              </Link>
            );
          })}
        ...
        <div className="p-4 border-t border-slate-800/50 bg-[#0A1128] space-y-4">
          ...
          {/* User Profile */}
          <div className="flex items-center justify-between gap-2 p-3 rounded-2xl bg-[#111827] hover:bg-slate-800 transition-colors group cursor-pointer border border-transparent hover:border-slate-700">
            <div className="flex items-center gap-3 truncate">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-800/80 text-slate-300 flex-shrink-0 group-hover:bg-slate-700 transition-colors">
              ...
              <div className="truncate">
                ...
                <p className="text-[13px] font-medium text-slate-400 truncate capitalize tracking-wide">
            ...
            <button
              ...
              title="Logout"
              className="h-10 w-10 flex-shrink-0 rounded-xl flex items-center justify-center text-slate-400 hover:text-white transition-colors"
            >
        ...
        <header className="sticky top-0 z-10 flex h-[88px] bg-white dark:bg-[#0B0F19] border-b border-slate-200 dark:border-slate-800/50 px-4 md:px-8 items-center justify-between shadow-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-4">
              <div className="flex h-[52px] w-[52px] items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg shadow-primary/30 flex-shrink-0 cursor-pointer hover:bg-primary/90 transition-colors">
